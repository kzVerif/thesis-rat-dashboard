...
Users CRUD API แตกต่างจาก `POST /api/auth/register` โดย Users API ใช้สำหรับผู้มีสิทธิ์จัดการบัญชีผู้ใช้ ส่วน Register ใช้สำหรับสมัครบัญชีใหม่ด้วย Role เริ่มต้น `VIEWER`
