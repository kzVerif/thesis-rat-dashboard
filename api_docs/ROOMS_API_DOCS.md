...
| `agent_count` | number | จำนวน Agent ทั้งหมดที่อยู่ในห้อง |
| `online_agent_count` | number | จำนวน Agent ออนไลน์ที่อยู่ในห้อง |
| `offline_agent_count` | number | จำนวน Agent ออฟไลน์ที่อยู่ในห้อง |
